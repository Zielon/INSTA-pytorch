...
//         printf("[n=%d] num_steps=%d, T=%f, grad_sigmas=%f, r_final=%f, d_final=%f, r=%f\n", n, step, T, grad_sigmas[0], r_final, d_final, r);
//         printf("[n=%d] num_steps=%d, T=%f, grad_depth=%f, d=%f, t=%f d_final=%f\n", n, step, T, grad_depth[0], d, t, d_final);
        // minimal remained transmittence
        if (T < T_thresh) break;
